...
class HomeViewController: UIViewController {
    ...
    private var planetBoxView: UIView!
    private var isPlanetBoxVisible = true
    ...
    private func setupGlassmorphismBox() {
        ...
        self.view.addSubview(planetBoxView)
    ...
    @objc private func planetButtonTapped(_ sender: UIButton) {
        ...
        showARView(for: selectedPlanet)
    }
    
    private func showARView(for planet: Planet) {
